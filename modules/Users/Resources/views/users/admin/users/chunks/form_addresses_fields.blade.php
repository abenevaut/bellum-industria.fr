...
<div class="form-group form-group-default">
    ...
    {!! Addresses::selectCountry('address['.$type.'][country]', old('address['.$type.'][country]', (!empty($address) ? $address->country : \Config::get('users.default_country'))), array('class'=>'form-control js-call-select2', 'style' => '100%')) !!}
</div>
