	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				{!! Form::open(array('route' => ['users.update-my-profile'], 'class' => 'forms js-call-form_validation well', 'method' => 'PUT')) !!}
				@if (count($errors) > 0)
				...
				<div>
					<ul class="nav nav-tabs">
						@foreach (\CVEPDB\Settings\Facades\Settings::get('addresses.flags') as $type)
							@if ($type == 'primary')
								<li class="active">
									<a href="#primary" data-toggle="tab" aria-expanded="true">Primary
										address</a></li>
							@elseif ($type == 'billing')
								<li class="">
									<a href="#billing" data-toggle="tab" aria-expanded="false">Billing
										address</a></li>
							@elseif ($type == 'shipping')
								<li class="">
									<a href="#shipping" data-toggle="tab" aria-expanded="false">Shipping
										address</a></li>
							@endif
						@endforeach
					</ul>
