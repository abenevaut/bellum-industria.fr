...
<div class="box box-primary box-widget collapsed-box">
    ...
    <div class="box-body">
        ...
        <div class="form-group form-group-default">
            ...
            {{ Form::select('filesystems_disks_s3_region', ['us-east-1' => 'US East (N. Virginia)', 'us-west-1' => 'US West (N. California)', 'us-west-2' => 'US West (Oregon)', 'eu-west-1' => 'EU (Ireland)', 'eu-central-1' => 'EU (Frankfurt)', 'ap-northeast-1' => 'Asia Pacific (Tokyo)', 'ap-northeast-2' => 'Asia Pacific (Seoul)', 'ap-southeast-1' => 'Asia Pacific (Singapore)', 'ap-southeast-2' => 'Asia Pacific (Sydney)', 'sa-east-1' => 'South America (São Paulo)'], old('mail_driver', $settings->get('filesystems.disks.s3.region')), ['class' => 'form-control']) }}
        </div>
        <div class="form-group form-group-default">
