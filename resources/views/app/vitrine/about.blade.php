	...
	<div class="layout__body-wrapper__content-wrapper layout__body-wrapper__content-wrapper--odd">
		...
		<div class="layout__body-wrapper__content-wrapper__inner">
			...
			<div class="one-third center">
				...
				<h5>{!! trans('cvepdb/global.cvepdb_author') !!}
					<span>{!! trans('cvepdb/global.cvepdb_author_grade') !!}</span>
				</h5>
				...
				<ul class="social team">
					<li>
						<a href="https://github.com/42antoine" target="_blank"><i class="icon-s-github"></i></a>
					</li>
					<li>
						<a href="https://plus.google.com/u/0/b/111705473242712184339/111705473242712184339/posts" target="_blank"><i class="icon-s-gplus"></i></a>
					</li>
					<li>
						<a href="https://www.youtube.com/channel/UCRit4sV0dh71lr8gXcDFq4g"><i class="icon-s-youtube"></i></a>
					</li>
					<li>
						<a href="http://fr.linkedin.com/pub/antoine-benevaut/36/39b/53a" target="_blank"><i class="icon-linkedin-squared"></i></a>
					</li>
					<li>
						<a href="https://twitter.com/42_antoine" target="_blank"><i class="icon-s-twitter"></i></a>
					</li>
					<li>
						<a href="https://soundcloud.com/42_antoine" target="_blank"><i class="icon-s-soundcloud"></i></a>
					</li>
				</ul>

				<ul>
					<li><b>{!! trans('cvepdb/global.siret') !!}</b>
						: {!! trans('cvepdb/global.cvepdb_siret') !!}</li>
				</ul>
