...
@if (config('addresses.show_country') && $show_country)
	<div class="form-group">
		{!! Form::label($prefix . '_address_country', trans('global.country_address'), ['class'=>'col-sm-3 control-label']) !!}
		<div class="col-sm-9">
...
@if (config('addresses.show_state') && $show_state)
	<div class="form-group">
		{!! Form::label($prefix . '_address_state_id', trans('global.state_or_province_address'), ['class'=>'col-sm-3 control-label']) !!}
		<div class="col-sm-9">
...
<div class="form-group">
	{!! Form::label($prefix . '_address_substate_id', trans('global.substate_address'), ['class'=>'col-sm-3 control-label']) !!}
	<div class="col-sm-9">
...
<div class="form-group">
	{!! Form::label($prefix . '_address_street', trans('global.street_address'), ['class'=>'col-sm-3 control-label']) !!}
	<div class="col-sm-9">
...
<div class="form-group">
	{!! Form::label($prefix . '_address_city', trans('global.city_or_town_address'), ['class'=>'col-sm-3 control-label']) !!}
	<div class="col-sm-4">
		{!! Form::text($prefix . '_address_city', old($prefix . '_address_city', $address['city']), ['class'=>'form-control']) !!}
	</div>
	{!! Form::label($prefix . '_address_zip', trans('global.zipcode_or_postal_code_address'), ['class'=>'col-sm-2 control-label']) !!}
	<div class="col-sm-3">
