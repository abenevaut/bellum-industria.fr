                    ...
                    <div class="row row-same-height">
                        ...
                        <div class="col-md-7">
                            <div class="padding-30">
                                ...
                                {!! Form::open(array('route' => 'clients.contacts.store', 'class' => 'forms js-call-form_validation', 'id' => 'contact')) !!}
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" class="form-control" name="first_name" value="{{ Auth::user()->first_name }}" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group form-group-default">
                                                <label>Last name</label>
                                                <input type="text" class="form-control" name="last_name" value="{{ Auth::user()->last_name }}" readonly="readonly">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default">
                                ...
                                <div class="form-group-attached">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" class="form-control" name="message" placeholder="Nom de votre entreprise" required="required">
                                    </div>
                                </div>
                                <br>
