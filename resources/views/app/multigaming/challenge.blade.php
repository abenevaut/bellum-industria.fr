			...
			<div class="toggle">
				...
				<div class="togglebox">
					<div>
						...
						<ul>
							<li>Son a la connection au serveur (VIP joinsound)
							</li>
						</ul>
						<h3>Caporal, 50 points</h3>

						<ul>
							<li>Message d&#39;accueil et de depart (VIP welcome
								and leave message)
							</li>
						</ul>
			...
			<div class="toggle">
				...
				<div class="togglebox">
					<div>
						...
						<ul>
							<li>Faisceau lumineux qui suit les grenades (VIP
								grenade trail)
							</li>
						</ul>
			...
			<div class="toggle">
				...
				<div class="togglebox">
					<div>
						...
						<h3>G&eacute;n&eacute;ral de corps d&#39;arm&eacute;e,
							3500 points</h3>
			...
			<div class="toggle">
				...
				<div class="togglebox">
					<div>
						...
						<h3>G&eacute;n&eacute;ral d&#39;arm&eacute;e, 4000
							points</h3>
