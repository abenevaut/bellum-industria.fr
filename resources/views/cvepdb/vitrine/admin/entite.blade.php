...
<table class="table table-hover table-condensed table-detailed dataTable no-footer" id="detailedTable" role="grid">
    <thead>
        <tr role="row">
            ...
            <th class="sorting_disabled" rowspan="1" colspan="1">SIRET</th>
    ...
    <tbody>
        @foreach ($entites as $entite)
            <tr role="row" class="odd">
                <td class="v-align-middle semi-bold">{{ $entite->name }}</td>
                <td class="v-align-middle semi-bold">{{ $entite->siret }}</td>
                <td class="v-align-middle">{{ $entite->phone }}</td>
                {{--<td class="v-align-middle semi-bold">{{ $entite->email }}</td>--}}
...
<div class="overlay" style="display: none" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            <!-- BEGIN Overlay Logo !-->
            <img class="overlay-brand" src="/dist/img/logo.png" alt="logo" data-src="/dist/img/logo.png" data-src-retina="/dist/img/logo_2x.png" width="78" height="22">
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50" src="/dist/img/profiles/avatar.jpg" data-src="/dist/img/profiles/avatar.jpg" data-src-retina="/dist/img/profiles/avatar2x.jpg" alt="">
                                </div>
                            </div>
                ...
                <div class="view bg-white">
                    ...
                    <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="/dist/img/profiles/1x.jpg" data-src="/dist/img/profiles/1.jpg" src="/dist/img/profiles/1x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="/dist/img/profiles/2x.jpg" data-src="/dist/img/profiles/2.jpg" src="/dist/img/profiles/2x.jpg" class="col-top">
                        </span>
                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="/dist/img/profiles/3x.jpg" data-src="/dist/img/profiles/3.jpg" src="/dist/img/profiles/3x.jpg" class="col-top">
                        </span>
                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="/dist/img/profiles/avatar_small.jpg" alt="" data-src="/dist/img/profiles/avatar_small.jpg" data-src-retina="/dist/img/profiles/avatar_small2x.jpg">
                            </div>
