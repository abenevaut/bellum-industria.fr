                    ...
                    <div id="basicTable_wrapper" class="dataTables_wrapper form-inline no-footer">
                        ...
                        <table class="table table-hover dataTable no-footer" id="basicTable" role="grid">
                            ...
                            <tr role="row">
                                ...
                                <th style="width: 20%;" class="sorting_asc" tabindex="0" aria-controls="basicTable" rowspan="1" colspan="1" aria-sort="ascending"
                            ...
                            @foreach ($entites as $entite)
                                ...
                                <tr role="row" class="odd">
                                    <td class="v-align-middle">
                                        <div class="checkbox ">
                                            <input type="checkbox" value="{{ $entite->id }}" id="checkbox{{ $entite->id }}">
