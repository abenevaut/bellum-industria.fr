						...
						{{--<div class="widget-1 panel no-border bg-complete no-margin widget-loader-circle-lg">--}}
							...
							{{--<div class="panel-body">--}}
								{{--<div class="pull-bottom bottom-left bottom-right ">--}}
									...
									{{--<br>--}}
									{{--<h2 class="text-white">Click anywhere to get--}}
										{{--Quick Search</h2>--}}
									{{--<p class="text-white hint-text">Learn More--}}
										{{--at Project Pages</p>--}}
								...
								{{--<div class="row-sm-height">--}}
                                  ...
                                  {{--</span>--}}
											...
											{{--<div class="panel-controls">--}}
												{{--<ul>--}}
													{{--<li>--}}
														{{--<a href="#" class="portlet-refresh text-black" data-toggle="refresh"><i--}}
								...
								{{--<div class="row-sm-height">--}}
									{{--<div class="col-sm-height col-top">--}}
										{{--<div class="p-l-20 p-r-20">--}}
											{{--<h5 class="no-margin p-b-5 pull-left hint-text">--}}
												{{--Pages</h5>--}}
											{{--<p class="pull-right no-margin bold hint-text">--}}
												{{--2,563</p>--}}
								...
								{{--<div class="row row-xs-height">--}}
									{{--<div class="col-xs-5 col-xs-height col-middle relative">--}}
										{{--<div class="padding-15 top-left bottom-left">--}}
											{{--<h5 class="hint-text no-margin p-l-10">--}}
												{{--France, Florence</h5>--}}
											{{--<p class=" bold font-montserrat p-l-10">--}}
												{{--2,345,789--}}
												{{--<br>USD</p>--}}
											{{--<p class=" hint-text visible-xlg p-l-10">--}}
												{{--Today's sales</p>--}}
										{{--</div>--}}
									{{--</div>--}}
						...
						{{--<div class="widget-2 panel no-border bg-primary widget widget-loader-circle-lg no-margin">--}}
							{{--<div class="panel-heading">--}}
								{{--<div class="panel-controls">--}}
									{{--<ul>--}}
										{{--<li>--}}
											{{--<a href="#" class="portlet-refresh" data-toggle="refresh"><i--}}
							...
							{{--<div class="panel-body">--}}
								{{--<div class="pull-bottom bottom-left bottom-right padding-25">--}}
									{{--<span class="label font-montserrat fs-11">NEWS</span>--}}
									{{--<br>--}}
									{{--<h3 class="text-white">So much more to see--}}
										{{--at a glance.</h3>--}}
									...
									{{--<div class="slide-front tiles slide active">--}}
										{{--<div class="padding-30">--}}
											...
											{{--<div class="pull-bottom p-b-30">--}}
												{{--<p class="p-t-10 fs-12 p-b-5 hint-text">--}}
													{{--21 Jan</p>--}}
						...
						{{--<div class="panel no-border bg-master widget widget-6 widget-loader-circle-lg no-margin">--}}
							{{--<div class="panel-heading">--}}
								{{--<div class="panel-controls">--}}
									{{--<ul>--}}
										{{--<li>--}}
											{{--<a data-toggle="refresh" class="portlet-refresh" href="#"><i class="portlet-icon portlet-icon-refresh-lg-white"></i></a>--}}
										{{--</li>--}}
									{{--</ul>--}}
								{{--</div>--}}
							{{--</div>--}}
							{{--<div class="panel-body">--}}
								{{--<div class="pull-bottom bottom-left bottom-right padding-25">--}}
									...
									{{--<p class="text-white m-t-20">Feels like--}}
										{{--rainy</p>--}}
									{{--<p class="text-white hint-text m-t-30">--}}
										{{--November 2014, 5 Thusday </p>--}}
								{{--</div>--}}
							{{--</div>--}}
						{{--</div>--}}
						{{--<!-- END WIDGET -->--}}
									...
									{{--<div class="slide-front tiles slide active">--}}
										{{--<div class="padding-30">--}}
											{{--<div class="pull-bottom p-b-30 bottom-right bottom-left p-l-30 p-r-30">--}}
												{{--<h5 class="no-margin semi-bold p-b-5">--}}
													{{--Apple Inc.</h5>--}}
												{{--<p class="no-margin text-black hint-text">--}}
													{{--NASDAQ : AAPL - NOV 01 8:40--}}
													{{--AM ET</p>--}}
												{{--<h3 class="semi-bold text-white">--}}
													{{--<i--}}
															{{--class="fa fa-sort-up small text-white"></i>--}}
													{{--0.15 (0.13%)--}}
												{{--</h3>--}}
												{{--<p>--}}
											...
											{{--<div class="row-sm-height">--}}
												{{--<div class="col-sm-height padding-25">--}}
													{{--<p class="hint-text text-black">--}}
														{{--Pre-market: 116.850.50--}}
														{{--(0.43%)--}}
													{{--</p>--}}
													{{--<p class="p-t-10 text-black">--}}
														{{--AAPL - Apple inc.</p>--}}
													{{--<div class="p-t-10">--}}
														{{--<p class="hint-text inline">--}}
															{{--+0.42%--}}
													...
													{{--<div class="p-t-10">--}}
														...
														{{--</p>--}}
														{{--<div class="inline">--}}
															{{--<i class="fa fa-sort-down small text-white fs-16 col-top"></i>--}}
														{{--</div>--}}
													{{--</div>--}}
												{{--</div>--}}
											{{--</div>--}}
				...
				{{--<div class="widget-11 panel no-border  no-margin widget-loader-bar">--}}
					...
					{{--<div class="widget-11-table auto-overflow">--}}
						{{--<table class="table table-condensed table-hover">--}}
							{{--<tbody>--}}
								{{--<tr>--}}
									{{--<td class="font-montserrat all-caps fs-12">--}}
										{{--Purchase CODE #2345--}}
									{{--</td>--}}
									{{--<td class="text-right">--}}
								...
								{{--<div class="col-xlg-8 ">--}}
									{{--<div class="p-l-10">--}}
										...
										{{--<div class="full-width">--}}
											{{--<ul class="list-inline">--}}
												{{--<li>--}}
													{{--<a href="#" class="font-montserrat text-master">1D</a>--}}
												{{--</li>--}}
												{{--<li class="active">--}}
													{{--<a href="#" class="font-montserrat  bg-master-light text-master">5D</a>--}}
												{{--</li>--}}
												{{--<li>--}}
													{{--<a href="#" class="font-montserrat text-master">1M</a>--}}
												{{--</li>--}}
												{{--<li>--}}
													{{--<a href="#" class="font-montserrat text-master">1Y</a>--}}
												{{--</li>--}}
											{{--</ul>--}}
										{{--</div>--}}
									...
									{{--<div class="company-stat-boxes">--}}
										{{--<div data-index="0" class="company-stat-box m-t-15 active padding-20 bg-master-lightest">--}}
											...
											{{--<div class="m-t-10">--}}
												{{--<p class="pull-left small hint-text no-margin p-t-5">--}}
													{{--9:42AM ET</p>--}}
												{{--<div class="pull-right">--}}
													{{--<p class="small hint-text no-margin inline">--}}
														{{--37.73</p>--}}
										...
										{{--<div data-index="1" class="company-stat-box m-t-15  padding-20 bg-master-lightest">--}}
											{{--<div>--}}
												...
												{{--</button>--}}
												{{--<p class="company-name pull-left text-uppercase bold no-margin">--}}
													{{--<span class="fa fa-circle text-primary fs-11"></span>--}}
													{{--YHOO--}}
												{{--</p>--}}
												{{--<small class="hint-text m-l-10">--}}
													{{--Yahoo Inc.--}}
										...
										{{--<div data-index="2" class="company-stat-box m-t-15  padding-20 bg-master-lightest">--}}
											{{--<div>--}}
												...
												{{--</button>--}}
												{{--<p class="company-name pull-left text-uppercase bold no-margin">--}}
													{{--<span class="fa fa-circle text-complete fs-11"></span>--}}
													{{--GOOG--}}
												{{--</p>--}}
												{{--<small class="hint-text m-l-10">--}}
													{{--Yahoo Inc.--}}
			...
			{{--<div class="widget-11-2 panel no-border panel-condensed no-margin widget-loader-circle">--}}
				...
				{{--<div class="auto-overflow widget-11-2-table">--}}
					{{--<table class="table table-condensed table-hover">--}}
						{{--<tbody>--}}
							{{--<tr>--}}
								{{--<td class="font-montserrat all-caps fs-12 col-lg-6">--}}
									{{--Purchase CODE #2345--}}
								{{--</td>--}}
			...
			{{--<div class="widget-15 panel panel-condensed  no-margin no-border widget-loader-circle">--}}
				{{--<div class="panel-heading">--}}
					{{--<div class="panel-controls">--}}
						{{--<ul>--}}
							{{--<li>--}}
								{{--<a href="#" class="portlet-collapse" data-toggle="collapse"><i--}}
				...
				{{--<div class="panel-body no-padding">--}}
					...
					{{--<div class="p-t-20 p-l-20 p-r-20 p-b-30">--}}
						{{--<div class="row">--}}
							{{--<div class="col-md-9">--}}
								{{--<p class="fs-16 text-black">Apple’s Motivation ---}}
									{{--Innovation--}}
									{{--<br>distinguishes between A leader and a--}}
									{{--follower.--}}
								{{--</p>--}}
								{{--<p class="small hint-text">VIA Apple Store--}}
									{{--(Consumer and Education Individuals)--}}
									{{--<br>(800) MY-APPLE (800-692-7753)--}}
								{{--</p>--}}
							{{--</div>--}}
							{{--<div class="col-md-3 text-right">--}}
								{{--<p class="font-montserrat bold text-success m-r-20 fs-16">--}}
									{{--+0.94</p>--}}
								{{--<p class="font-montserrat bold text-danger m-r-20 fs-16">--}}
									{{---0.63</p>--}}
							{{--</div>--}}
						{{--</div>--}}
					{{--</div>--}}
					...
					{{--<div class="row">--}}
						{{--<div class="col-md-9">--}}
							{{--<p class="fs-16 text-black">Apple’s Motivation ---}}
								...
								{{--follower.--}}
							{{--</p>--}}
							{{--<p class="small hint-text">VIA Apple Store (Consumer--}}
								{{--and Education Individuals)--}}
								{{--<br>(800) MY-APPLE (800-692-7753)--}}
							{{--</p>--}}
						{{--</div>--}}
						{{--<div class="col-md-3 text-right">--}}
							{{--<h5 class="font-montserrat bold text-success">--}}
								{{--+0.94</h5>--}}
							{{--<h5 class="font-montserrat bold text-danger">--}}
								{{---0.63</h5>--}}
						{{--</div>--}}
					{{--</div>--}}
				{{--</div>--}}
		...
		{{--<div class="col-md-4 col-lg-3 col-xlg-3 m-b-10">--}}
			...
			{{--<div class="widget-16 panel no-border  no-margin widget-loader-circle">--}}
				...
				{{--<div class="widget-16-header padding-20">--}}
					...
					{{--<div class="pull-left">--}}
						{{--<p class="hint-text all-caps font-montserrat  small no-margin overflow-ellipsis ">--}}
							{{--Pages name--}}
						{{--</p>--}}
						{{--<h5 class="no-margin overflow-ellipsis ">Webarch Sales--}}
							{{--Analysis</h5>--}}
					{{--</div>--}}
					{{--<div class="clearfix"></div>--}}
				{{--</div>--}}
				...
				{{--<div class="p-l-20 p-r-20 p-t-10 p-b-10 ">--}}
					{{--<p class="pull-left no-margin hint-text">Super secret--}}
						{{--options</p>--}}
			...
			{{--<div class="widget-18 panel no-border  no-margin ">--}}
				{{--<div class="padding-15">--}}
					{{--<div class="item-header clearfix">--}}
						{{--<div class="thumbnail-wrapper d32 circular">--}}
							{{--<img width="40" height="40" src="/assets/images/profiles/3x.jpg" data-src="/assets/images/profiles/3.jpg" data-src-retina="/assets/images/profiles/3x.jpg" alt="">--}}
						{{--</div>--}}
				...
				{{--<div class="padding-15">--}}
					...
					{{--<ul class="list-inline pull-right no-margin">--}}
						{{--<li><a class="text-master hint-text" href="#">5,345--}}
								{{--<i class="fa fa-comment-o"></i></a>--}}
						{{--</li>--}}
						{{--<li><a class="text-master hint-text" href="#">23K--}}
			...
			{{--<div class="row">--}}
				{{--<div class="col-xlg-12">--}}
					...
					{{--<div class="panel no-border  no-margin">--}}
						...
						{{--<hr class="no-margin">--}}
						{{--<div class="padding-15">--}}
							{{--<p>Inspired by : good design is obvious, great--}}
								{{--design is transparent</p>--}}
						...
						{{--<div class="relative">--}}
							...
							{{--<div class="widget-19-post no-overflow">--}}
								{{--<img src="/assets/images/social-post-image.png" class="block center-margin relative" alt="Post">--}}
							{{--</div>--}}
						{{--</div>--}}
						{{--<div class="padding-15">--}}
							{{--<div class="hint-text pull-left">few seconds ago--}}
							{{--</div>--}}
							{{--<ul class="list-inline pull-right no-margin">--}}
								{{--<li><a class="text-master hint-text" href="#">5,345--}}
										{{--<i class="fa fa-comment-o"></i></a>--}}
							...
							{{--<div class="col-md-12 col-xlg-6">--}}
								{{--<div class="row m-t-20">--}}
									{{--<div class="col-md-5">--}}
										...
										{{--<p class="small hint-text">9th August--}}
											{{--2014</p>--}}
									{{--</div>--}}
									{{--<div class="col-md-7">--}}
										{{--<div class="pull-left">--}}
											{{--<p class="small hint-text no-margin">--}}
												{{--Currently</p>--}}
