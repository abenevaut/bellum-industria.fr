...
@section('breadcrumbs')
    @include('backend.partials.default.breadcrumbs', ['breadcrumbs' => [
        ...
        route('backend.users.create') => trans('users.create.title'),
    ]])
@endsection
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-10">
                        ...
                        {!! Form::open(['route' => 'backend.users.store', 'id' => 'form-work', 'class' => 'form-horizontal', 'role' => 'form', 'autoprimary' => 'off', 'novalidate' => 'novalidate', 'data-user_identifier' => 0]) !!}
