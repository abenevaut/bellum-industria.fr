...
@section('content')
    ...
    @if (count($errors) > 0)
        <div class="callout callout-danger">
            <h4>{{ count($errors) > 1 ? trans('global.errors') : trans('global.error') }}</h4>
        ...
        <div class="box-body">
            <div class="form-group form-group-lg p-b-60">
                <label for="db_host" class="col-sm-3 control-label">
                    {{ trans('installer.field_db_host_title') }}<br/>
                    <span class="instruction">{{ trans('installer.field_db_host_instruction') }}</span>
                </label>
                <div class="col-sm-9">
                    <input type="text" class="form-control input-lg" id="db_host" placeholder="{{ trans('installer.field_db_host_placeholder') }}"
                           name="DB_HOST" value="{{ old('DB_HOST') }}">
                </div>
            </div>
            <div class="form-group form-group-lg p-b-60">
                <label for="db_database" class="col-sm-3 control-label">
                    {{ trans('installer.field_db_database_title') }}<br/>
                    <span class="instruction">{{ trans('installer.field_db_database_instruction') }}</span>
                </label>
                <div class="col-sm-9">
                    <input type="text" class="form-control input-lg" id="db_database" placeholder="{{ trans('installer.field_db_database_placeholder') }}"
                           name="DB_DATABASE" value="{{ old('DB_DATABASE') }}">
                </div>
            </div>
            <div class="form-group form-group-lg p-b-60">
                <label for="db_username" class="col-sm-3 control-label">
                    {{ trans('installer.field_db_username_title') }}<br/>
                    <span class="instruction">{{ trans('installer.field_db_username_instruction') }}</span>
                </label>
                <div class="col-sm-9">
                    <input type="text" class="form-control input-lg" id="db_username" placeholder="{{ trans('installer.field_db_username_placeholder') }}"
                           name="DB_USERNAME" value="{{ old('DB_USERNAME') }}">
                </div>
            </div>
            <div class="form-group form-group-lg p-b-60">
                <label for="db_password" class="col-sm-3 control-label">
                    {{ trans('installer.field_db_password_title') }}<br/>
                    <span class="instruction">{{ trans('installer.field_db_password_instruction') }}</span>
                </label>
                <div class="col-sm-9">
                    <input type="password" class="form-control input-lg" id="db_password" placeholder="{{ trans('installer.field_db_password_placeholder') }}"
                           name="DB_PASSWORD">
                </div>
            </div>
        </div>
