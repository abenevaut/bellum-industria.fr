...
if ('production' === bellumindustria.environment)
{
    ...
    ga('production.set', dimensions.TRACKING_VERSION, bellumindustria.version);
    ga('test.set', dimensions.TRACKING_VERSION, bellumindustria.version);
    ...
    ga('production.set', dimensions.USER_ID, bellumindustria.user_id);
    ga('test.set', dimensions.USER_ID, bellumindustria.user_id);
    ga('production.set', 'userId', bellumindustria.user_id);
    ga('test.set', 'userId', bellumindustria.user_id);

    ga('production.set', dimensions.ROLE_ID, bellumindustria.user_role);
    ga('test.set', dimensions.ROLE_ID, bellumindustria.user_role);
