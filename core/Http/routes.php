...
Route::group(['middleware' => ['api'], 'prefix' => 'api'], function ()
{
	...
	Route::get('v1/settings/get', '\Core\Http\Controllers\Api\MapController@geolocalisation');
	Route::get('v1/settings/get', '\Core\Http\Controllers\Api\MapController@address');
});
//
