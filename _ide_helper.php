 ...
 * Generated for Laravel 5.2.24 on 2016-04-29.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Core\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Core\Console\Kernel::queue($command, $parameters);
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \Core\Domain\Users\Entities\User|null 
         * @static 
         */
    ...
    class Password extends \Illuminate\Support\Facades\Password{
        ...
        public static function broker($name = null){
            return \Modules\Users\Brokers\PasswordBrokerManager::broker($name);
        }
         ...
         */
        public static function getDefaultDriver(){
            return \Modules\Users\Brokers\PasswordBrokerManager::getDefaultDriver();
        }
         ...
         */
        public static function setDefaultDriver($name){
            \Modules\Users\Brokers\PasswordBrokerManager::setDefaultDriver($name);
        }
    ...
    class ApiGuardAuth extends \Chrisbjr\ApiGuard\Facades\ApiGuardAuth{
        
        /**
         * Authenticate a user via the API key.
         *
         * @param \Chrisbjr\ApiGuard\ApiKeyRepository $apiKey
         * @return bool|mixed 
         * @static 
         */
        public static function authenticate($apiKey){
            return \Chrisbjr\ApiGuard\ApiGuardAuth::authenticate($apiKey);
        }
        ...
        public static function isAuthenticated(){
            return \Chrisbjr\ApiGuard\ApiGuardAuth::isAuthenticated();
        }
         ...
         */
        public static function getUser(){
            return \Chrisbjr\ApiGuard\ApiGuardAuth::getUser();
        }
    ...
    class Theme extends \Pingpong\Themes\ThemeFacade{
        ...
        public static function registerNamespaces(){
            return \Pingpong\Themes\Repository::registerNamespaces();
        }
        ...
        public static function getCurrent(){
            return \Pingpong\Themes\Repository::getCurrent();
        }
         ...
         */
        public static function getCached(){
            return \Pingpong\Themes\Repository::getCached();
        }
        ...
        public static function cache(){
            return \Pingpong\Themes\Repository::cache();
        }
         ...
         */
        public static function setPath($path){
            return \Pingpong\Themes\Repository::setPath($path);
        }
        ...
        public static function view($view, $data = array(), $mergeData = array()){
            return \Pingpong\Themes\Repository::view($view, $data, $mergeData);
        }
        ...
        public static function asset($asset, $secure = null){
            return \Pingpong\Themes\Repository::asset($asset, $secure);
        }
        ...
        public static function secure_asset($asset){
            return \Pingpong\Themes\Repository::secure_asset($asset);
        }
        ...
        public static function lang($key, $replace = array(), $locale = null){
            return \Pingpong\Themes\Repository::lang($key, $replace, $locale);
        }
        ...
        public static function getNamespace($key){
            return \Pingpong\Themes\Repository::getNamespace($key);
        }
    ...
    class Addresses extends \CVEPDB\Addresses\AddressesFacade{
         ...
         * @static 
         */
        public static function createAddress($data = null, $user_id = 0){
            return \CVEPDB\Addresses\Addresses::createAddress($data, $user_id);
        }
        
        /**
         * Create a new address using post array data
         *
         * @param object|int $address
         * @param array $data
         * @param int $user_id default 0
         * @return object $address or null
         * @static 
         */
        public static function updateAddress($address, $data = null, $user_id = 0){
            return \CVEPDB\Addresses\Addresses::updateAddress($address, $data, $user_id);
        }
         ...
         * @static 
         */
        public static function deleteAddress($address, $user_id = 0){
            return \CVEPDB\Addresses\Addresses::deleteAddress($address, $user_id);
        }
         ...
         * @return \CVEPDB\Addresses\Illuminate\Validation\Validator ready to test for fails|passes
         * @static 
         */
        public static function getValidator($input = null){
            return \CVEPDB\Addresses\Addresses::getValidator($input);
        }
        
        /**
         * Return Collection of Addresses owned by the given userID.
         *
         * @param \CVEPDB\Addresses\Collection
         * @static 
         */
        public static function getAll($userId = null){
            return \CVEPDB\Addresses\Addresses::getAll($userId);
        }
         ...
         * @static 
         */
        public static function getList($userId = null){
            return \CVEPDB\Addresses\Addresses::getList($userId);
        }
        
        /**
         * Return collection of all countries
         *
         * @return \CVEPDB\Addresses\Collection 
         * @static 
         */
        public static function getCountries(){
            return \CVEPDB\Addresses\Addresses::getCountries();
        }
        ...
        public static function getStates($countryA2 = 'US'){
            return \CVEPDB\Addresses\Addresses::getStates($countryA2);
        }
         ...
         * @return \CVEPDB\Addresses\$string full country name
         * @static 
         */
        public static function countryName($countryA2){
            return \CVEPDB\Addresses\Addresses::countryName($countryA2);
        }
         ...
         * @return \CVEPDB\Addresses\$string full state/province name
         * @static 
         */
        public static function stateName($stateA2, $countryA2 = 'US'){
            return \CVEPDB\Addresses\Addresses::stateName($stateA2, $countryA2);
        }
         ...
         * @static 
         */
        public static function selectCountry($name, $selected = 'US', $options = array()){
            return \CVEPDB\Addresses\Addresses::selectCountry($name, $selected, $options);
        }
         ...
         * @param string $name
         * @param string $selected
         * @param array $options $options['country'] = 'US'
         * @static 
         */
        public static function selectState($name, $selected = null, $options = array()){
            return \CVEPDB\Addresses\Addresses::selectState($name, $selected, $options);
        }
