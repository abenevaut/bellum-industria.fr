...
use Session;
use Redirect;
use CVEPDB\Contracts\Services\Outputters\Outputter;
use CVEPDB\Contracts\Services\Outputters\OutputterHTML;
use CVEPDB\Contracts\Services\Outputters\OutputterSitemap;
use CVEPDB\Contracts\Services\Outputters\OutputterSitemapFormat;
use CVEPDB\Contracts\Services\Outputters\OutputterFeeds;
use CVEPDB\Contracts\Services\Outputters\OutputterFeedsFormat;
use CVEPDB\Contracts\Services\Outputters\OutputterPDF;
use \Creitive\Breadcrumbs\Breadcrumbs as Breadcrumbs;

class AbsLaravelOutputter implements /*Outputter,*/ OutputterHTML, OutputterSitemap, OutputterFeeds, OutputterPDF
{
    /**
    ...
    /**
     * @param IOutputterSitemapFormat $format
     * @param array $data
     * @param string $uri
    ...
    /**
     * @param IOutputterFeedsFormat $format
     * @param array $data
     * @param string $uri
