...
/**
 * Class CreateMetaTableCommand
 * @package cms\Console\Commands
 */
class CreateMetaTableCommand extends CommandAbstract
{
     ...
     * @var string
     */
    protected $name = 'cms:make:metatable';
     ...
     * @var string
     */
    protected $description = '[NOT WORKING!] Creates a migration for new metadata tables.';
