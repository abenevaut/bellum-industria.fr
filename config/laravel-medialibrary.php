...
return [
	 ...
	 */
	'media_model' => cms\Domain\Medias\Medias\Media::class,

	/*
	 * When urls to files get generated this class will be called. Leave empty
	 * if your files are stored locally above the site root or on s3.
	 */
	'custom_url_generator_class' => cms\Domain\Medias\Medias\UrlGenerator\PrivateStorageUrlGenerator::class,
