...
<!-- END CALENDAR -->
<!-- START EVENT MANAGER -->
{% include PATH + "pages/calendar/_calendar-event-manager.tpl" %}
<!-- START EVENT MANAGER -->
        ...
        <div class="view bg-white">
            <div class="navbar navbar-default">
                <div class="navbar-inner">
                    ...
                    <a class="inline action p-l-10 link text-master" data-toggle="quickview" data-toggle-element=
                    "#quickview"><i class="pg-close"></i></a> <!-- END Header Controler !-->
            ...
            <div class="list-view boreded no-top-border" data-init-list-view="ioslist">
                <div class="list-view-group-container">
                    ...
                    <ul>
                        ...
                        <li class="alert-list" data-locale="ar">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="ar-ma">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="ar-sa">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                            Arabic (Saudi Arabia)</p></a>
                        </li>
                        <li class="alert-list" data-locale="ar-tn">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="bn">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="my">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="hi">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="mr">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="me">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="ne">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="nn">
                            ...
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                            Norwegian Nynorsk</p></a>
                        </li>
                        <li class="alert-list" data-locale="fa">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
                        ...
                        <li class="alert-list" data-locale="bo">
                            <a href="#">
                            <p class="col-xs-height col-middle invisible"><span class="text-warning fs-10"><i class=
                            "fa fa-circle"></i></span></p>
                            <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12 text-master">
