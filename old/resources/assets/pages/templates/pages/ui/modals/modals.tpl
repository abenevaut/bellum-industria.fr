                  ...
                  <div class="col-xl-7 col-lg-6 bg-white">
                    ...
                    <div class="full-height">
                      <div class="card-body text-center">
                        <img class="image-responsive-height demo-mw-400" src="{# ASSETS #}/img/
demo/modal_hero.gif" alt="">
                      </div>
                    </div>
                    <!-- END card -->
                  </div>
...
profiles/avatar_small2x.jpg">
        ...
        <div class="{% if mode =='horizontal_menu' %} no-padding  {% else %} container-fluid {% endif %}  container-fixed-lg">
        ...
        <!-- END CONTAINER FLUID -->
        <!-- START CONTAINER FLUID -->
        <div class="{% if mode =='horizontal_menu' %} container  {% else %} container-fluid {% endif %}  container-fixed-lg bg-white">
          <div class="card card-transparent">
            <div class="card-header ">
              <div class="card-title">Boostrap Native Modals
              </div>
