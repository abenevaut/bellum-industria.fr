                    ...
                    <div class="col-xl-7 col-lg-6 bg-white">
                      ...
                      <div class="full-height">
                        <div class="card-body text-center">
                          <img class="image-responsive-height demo-mw-500" src="{# ASSETS #}/img/
demo/notifications_hero.gif" alt="">
                        </div>
                      </div>
                      <!-- END card -->
                    </div>
...
profiles/avatar_small2x.jpg">
          ...
          <!-- END CONTAINER FLUID -->
          <!-- START CONTAINER FLUID -->
          <div class="{% if mode =='horizontal_menu' %} no-padding  {% endif %} container-fluid container-fixed-lg bg-white">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="card card-transparent">
                    ...
                    <div class="card-body">
                      <div class="hidden">
                        <ul class="nav nav-tabs no-border position-tabs" role="tablist" id="preview-tab-position">
                          <li class="nav-item">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <div>
                      <div class="profile-img-wrapper m-t-5 inline">
                        <img alt="Avatar" width="35" height="35" src="{# ASSETS #}/img/
profiles/avatar_small.jpg" data-src="{# ASSETS #}/img/
profiles/avatar_small.jpg" data-src-retina="{# ASSETS #}/img/
profiles/avatar_small2x.jpg">
                        <div class="chat-status available">
                        </div>
