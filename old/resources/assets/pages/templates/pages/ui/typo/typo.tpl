...
{% endif %}
      <!-- START PAGE COVER -->
        <div class="jumbotron page-cover" data-pages="parallax" {% if mode =='horizontal_menu' %} data-scroll-element=".page-container" {% endif %}>
                  ...
                  <div class="card card-transparent">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <p class="no-margin"><a href="#">SegeoUI</a>
                          </p>
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <p class="no-margin"><a href="#">Helvetica Family</a>
                          </p>
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <p class="no-margin"><a href="#">Ubuntu</a>
                          </p>
