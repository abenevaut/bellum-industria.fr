    <div class="social-wrapper">
        <div class="social " data-pages="social">
           <!-- START JUMBOTRON -->
          <div class="jumbotron" data-social="cover" data-pages="parallax" {% if mode =='horizontal_menu' %} data-scroll-element=".page-container" {% endif %}>
            <div class="cover-photo">
              <img alt="Cover photo" src="{# ASSETS #}/img/social/cover.jpg" />
            </div>
            <div class="{% if mode =='horizontal_menu' %} container  {% else %} container-fluid {% endif %}  container-fixed-lg sm-p-l-0 sm-p-r-0">
              <div class="inner">
