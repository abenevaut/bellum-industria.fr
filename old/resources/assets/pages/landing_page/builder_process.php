...
switch($layout){
  case '1':
    ...
    break;
  case '2':
    $layoutClass = 'menu-pin';
    break;
  case '3':
    $layoutClass = 'menu-behind';
    break;
  case '4':
    $layoutClass = 'menu-pin menu-behind';
    break;
  default:
    $layoutClass = '';
    break;
...
switch($colors){
	case '1':
		...
		break;
	case '2':
		$theme ='pages/css/themes/corporate.css';
		break;
	case '3':
		$theme ='pages/css/themes/retro.css';
		break;
	case '4':
		$theme ='pages/css/themes/unlax.css';
		break;
	case '5':
		$theme ='pages/css/themes/vibes.css';
		break;
	case '6':
		$theme ='pages/css/themes/abstract.css';
		break;
  default:
    $theme ='pages/css/pages.css';
    break;
...
<html>
  <head>
    ...
    <link class="main-stylesheet" href="<?php echo $theme?>" rel="stylesheet" type="text/css" />
    <!--[if lte IE 9]>
  ...
  <body class="fixed-header <?php echo $layoutClass?>">
    <!-- BEGIN SIDEBAR -->
