...
@section('js')
	...
	<script src="{{ mix('assets/js/frontend/users/leads/index.js') }}"></script>
@endsection
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-7">
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Nom" name="last_name" value="@if (Auth::check()){{ Auth::user()->last_name }}@endif">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Prénom" name="first_name" value="@if (Auth::check()){{ Auth::user()->first_name }}@endif">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Courriel" name="email" value="@if (Auth::check()){{ Auth::user()->email }}@endif">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Sujet" name="subject" value="">
					</div>
					<div class="form-group">
