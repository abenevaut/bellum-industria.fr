<div class="header ">
	@include('backend.partials.default.header_mobile')
									...
									{{--<div class="notification-item unread clearfix">--}}
										{{--<div class="heading">--}}
											{{--<div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">--}}
												{{--<img width="30" height="30" data-src-retina="/img/profiles/1x.jpg" data-src="/img/profiles/1.jpg" alt="" src="/img/profiles/1.jpg">--}}
											{{--</div>--}}
											{{--<a href="#" class="text-primary pull-left">--}}
	...
	<div class=" pull-right">
		<div class="visible-lg visible-md m-t-10">
			<div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
				<span class="semi-bold">{{ Auth::user()->full_name }}</span>
			</div>
			<div class="dropdown pull-right">
				...
				<ul class="dropdown-menu profile-dropdown" role="menu">
					...
					<li><a href="{{ route('backend.users.profile.index') }}"><i class="fa fa-user"></i> Profile</a></li>
